...
class DisplayBasketAdapter(private val bicycles : List<Bicycle>) : RecyclerView.Adapter<DisplayBasketAdapter.BasketItemViewHolder>() {
    ...
    private lateinit var removeFromCartButtonListener : RemoveFromCartButtonListener
    ...
    class BasketItemViewHolder(itemView: View, private val removeFromCartButtonListener: RemoveFromCartButtonListener) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun setRemoveFromCartButtonListener()
        {
